...
void IP(int L, int n, char* s) // Именительный & Винительны
#include <stdio.h>
#include <locale.h>
static char* sot[] = { "ст","дв","тр","четыре",
            "пят","шест", "сем","восем","девят" };
...
void ImenitelVinitelPadez(int L, int n, char* s) // Именительный & Винительный
{
    int R, ns, nd;
    char* p;
    int M;
...
void RoditelPadez(unsigned long L, int n, char* s) //Родительный
{
    int R, ns, nd;
    char* p;
    unsigned long M;
...
void DatelPadez(unsigned long L, int n, char* s) // Дательный
{
    int R, ns, nd;
    char* p;
    unsigned long M;
...
void TvoritelPadez(unsigned long L, int n, char* s) // Творительный
{
    int R, ns, nd;
    char* p;
    unsigned long M;
...
void PredlozPadez(unsigned long L, int n, char* s) // Предложный
{
    int R, ns, nd;
    char* p;
    unsigned long M;
